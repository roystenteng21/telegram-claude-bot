...
DEV_NOTES_CONTENT = [
    ...
    ["Handoff — Session 8", "Last deploy: 'Session 8 — modularise into 17 modules; fix calendar.py stdlib conflict'. Bot live on Railway. calendar.py renamed to cal.py (stdlib conflict fix). All 17 modules deployed. Next: Session 9 (Trips schema migration + AviationStack strip) then Session 10 (GitHub auto-deploy, repo: roystenteng21/telegram-claude-bot, fresh token needed).", "2026-04-29"],
